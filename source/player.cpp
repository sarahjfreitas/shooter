...
Player::Player() : Sprite(100,100, "assets/ship360_64_0.png", 64, 64, 10) {}
...
void Player::draw(SDL_Renderer* renderer)
{
  switch(direction)
  {
    case Direction::Up:
      ...
      break;
    case Direction::Down:
      draw_(renderer, 0, height * 6);
      break;
    case Direction::Right:
      draw_(renderer, 0, height * 3);
      break;
    case Direction::Left:
      draw_(renderer, 0, height * 9);
      break;
    case Direction::UpRight:
      draw_(renderer, 0, height * 2);
      break;
    case Direction::DownRight:
      draw_(renderer, 0, height * 5);
      break;
    case Direction::DownLeft:
      draw_(renderer, 0, height * 8);
      break;
    case Direction::UpLeft:
      draw_(renderer, 0, height * 11);
      break;
  }
}
